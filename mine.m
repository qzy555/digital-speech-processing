...
tempr1=(0:overlap-1)'/overlap;            
tempr2=(overlap-1:-1:0)'/overlap;         
...
in=input('请输入伸缩语音的时间长度是原语音时间长度的倍数:','s');
rate=str2num(in);
in1=input('请输入基音频率升降的倍数:','s');  % 输入基音频率增降比例
rate1=str2num(in1);
